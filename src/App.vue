    ...
    <div id="app">
      <b-row dir="rtl">
        <b-navbar toggleable="lg" type="dark" variant="dark">
          ...
          <b-navbar-brand href="#">طلاگرام</b-navbar-brand>
          ...
          <b-collapse class="mr-15" id="nav-collapse" is-nav>
            <b-navbar-nav>
              <b-nav-item class="ml-2" href="#">
                <h6><b style="color:#bea44d"> اخبار بورس </b></h6>
              </b-nav-item>

              <b-nav-item class="ml-2" href="#">
                <h6><b style="color:#bea44d"> اخبار طلا و ارز </b></h6>
              </b-nav-item>
...
export default {
  ...
  async created() {
    ...
    await axios
      ...
      .then((response1) => {
        this.chartData = response1.data.Data;
      })
    ...
    //  var cartData1 = JSON.parse(JSON.stringify(this.chartData));

    // var chartData1 = JSON.parse(JSON.stringify(this.chartData));
